...
KeikoAdventures-Linux-Debug:
	 $(PROJECTBUILD) KeikoAdventures Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

KeikoAdventures-Linux-DebugGame:
	 $(PROJECTBUILD) KeikoAdventures Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

KeikoAdventures-Linux-Shipping:
	 $(PROJECTBUILD) KeikoAdventures Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

KeikoAdventures-Linux-Test:
	 $(PROJECTBUILD) KeikoAdventures Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

KeikoAdventures:
	 $(PROJECTBUILD) KeikoAdventures Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

KeikoAdventuresEditor-Linux-Debug:
	 $(PROJECTBUILD) KeikoAdventuresEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

KeikoAdventuresEditor-Linux-DebugGame:
	 $(PROJECTBUILD) KeikoAdventuresEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

KeikoAdventuresEditor-Linux-Shipping:
	 $(PROJECTBUILD) KeikoAdventuresEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

KeikoAdventuresEditor-Linux-Test:
	 $(PROJECTBUILD) KeikoAdventuresEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

KeikoAdventuresEditor:
	 $(PROJECTBUILD) KeikoAdventuresEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
