...
unrealRootPath=/UnrealEngine
KeikoAdventuresRootPath=/home/wssids/GDrive/KeikoAdventures

gameProjectFile=/home/wssids/GDrive/KeikoAdventures/KeikoAdventures.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(KeikoAdventuresSource.pri)
include(KeikoAdventuresHeader.pri)
include(KeikoAdventuresConfig.pri)
include(KeikoAdventuresIncludes.pri)
include(KeikoAdventuresDefines.pri)
...
KeikoAdventures-Linux-Debug.commands = $$build KeikoAdventures Linux Debug  -project="\"$$gameProjectFile\"" $$args
KeikoAdventures-Linux-DebugGame.commands = $$build KeikoAdventures Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
KeikoAdventures-Linux-Shipping.commands = $$build KeikoAdventures Linux Shipping  -project="\"$$gameProjectFile\"" $$args
KeikoAdventures-Linux-Test.commands = $$build KeikoAdventures Linux Test  -project="\"$$gameProjectFile\"" $$args
KeikoAdventures.commands = $$build KeikoAdventures Linux Development  -project="\"$$gameProjectFile\"" $$args

KeikoAdventuresEditor-Linux-Debug.commands = $$build KeikoAdventuresEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
KeikoAdventuresEditor-Linux-DebugGame.commands = $$build KeikoAdventuresEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
KeikoAdventuresEditor-Linux-Shipping.commands = $$build KeikoAdventuresEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
KeikoAdventuresEditor-Linux-Test.commands = $$build KeikoAdventuresEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
KeikoAdventuresEditor.commands = $$build KeikoAdventuresEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	KeikoAdventures-Linux-Debug \
	KeikoAdventures-Linux-DebugGame \
	KeikoAdventures-Linux-Shipping \
	KeikoAdventures-Linux-Test \
	KeikoAdventures \
	KeikoAdventuresEditor-Linux-Debug \
	KeikoAdventuresEditor-Linux-DebugGame \
	KeikoAdventuresEditor-Linux-Shipping \
	KeikoAdventuresEditor-Linux-Test \
	KeikoAdventuresEditor \
